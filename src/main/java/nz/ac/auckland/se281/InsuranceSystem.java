...
//Initialising a number variable for the for print-db statements using the method in Profiles class
...
//Creating IF conditions to check which print-db message gets printed
  ...
  // After the header line gets printed, we print the databse using the method made in profiles class
      profiles.PrintProfiles();
  }


  public void createNewProfile(String userName, String age) {
    //Made the input username into lowerstring, and then capitalised the first letter of the Username
  ...
  //If the input passes the parameters, we print the username and age into the databse using the method in the Profiles class.
