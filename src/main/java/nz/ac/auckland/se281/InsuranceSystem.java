...
public class InsuranceSystem {
  ...
  public void printDatabase() {
    // Initialising a number variable for the for print-db statements using the
    // method in Profiles
    // class
    ...
    // After the header line gets printed, we print the databse using the method
    // made in profiles
    // class
  ...
  public void createNewProfile(String userName, String age) {
    // Made the input username into lowerstring, then capitalised the first letter
    // of the Username
    ...
    // Using the method implemented in Profiles to check if its only numeric values
    // in the string
  ...
  public void deleteProfile(String userName) {
    // Formatting the username of the profile we want to delete into the correct
    // format so it's
