...
public abstract class Policies {
  // Creating protected variables that each policy have in common and are used in
  // the abstract
  ...
  // Creating a constructor that takes in the options array, the user name and the
  // age
  ...
  // Creating an abstract method that will be implemented in the sub classes to
  // calculate the base
  // premium
